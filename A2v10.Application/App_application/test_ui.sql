...
begin
	...
	values
		...
		(10,   1,  N'Документи',           N'document', null, 10),
		(20,   1,  N'Довідники',           N'catalog',  null, 20),
		(101, 10,  N'Прибуткові накладні', N'waybill',  N'file',  10),
		(201, 20,  N'Покупці',             N'customer', N'users', 10),
		(202, 20,  N'Товари',              N'product',  N'package-outline', 20)
