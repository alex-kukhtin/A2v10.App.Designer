...
begin
	...
	select [Agent!TAgent!Object] = null, [Id!!Id] = a.Id, a.[Name], a.[Code], a.[Memo], a.[FullName]
...
begin
	...
	from 
		[sample].[Agents] a
	where 
		a.Kind = @Kind and (@Fragment is null or upper(a.Name) like @Fragment or upper(a.Code) like @Fragment or upper(a.Memo) like @Fragment or upper(a.FullName) like @Fragment)
	order by 
	...
	select [Agents!TAgent!Array] = null, [Id!!Id] = a.Id, a.[Name], a.[Code], a.[Memo], a.[FullName],
		[!!RowCount] = t._rows
...
begin
	set nocount on;
	set transaction isolation level read uncommitted;
	select [Product!TProduct!Object] = null, [Id!!Id] = p.Id
